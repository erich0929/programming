...
public class DraggingTextFromStyledText {
	...
	public static void main(String[] args) {
		...
		int style = SWT.MULTI | SWT.WRAP | SWT.H_SCROLL | SWT.V_SCROLL
				| SWT.BORDER;
		...
		DropTarget target = new DropTarget(text2, DND.DROP_DEFAULT
		...
		target.addDropListener(new DropTargetAdapter() {
			...
			public void dragOver(DropTargetEvent e) {
				...
				try {
					int offset = text2.getOffsetAtLocation(new Point(
