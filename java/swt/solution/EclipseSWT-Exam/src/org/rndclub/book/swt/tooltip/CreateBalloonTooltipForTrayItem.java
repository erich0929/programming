...
public class CreateBalloonTooltipForTrayItem {
...
public static void main(String[] args) {
	...
	if (tray != null) {
		...
		image = new Image(display, CreateBalloonTooltipForTrayItem.class.getResourceAsStream("/org/rndclub/swt/res/images/idea.jpg"));
		item.setImage(image);
