 ...
 * @since 3.2
 */
public class UseRiseAndFontWithStyleRange {
	...
	public static void main(String[] args) {
		...
		Font font1 = new Font(display, data.getName(), data.getHeight() * 2,
				data.getStyle());
		Font font2 = new Font(display, data.getName(),
				data.getHeight() * 4 / 5, data.getStyle());
		...
		int[] ranges = new int[] { 16, 4, 61, 13, 107, 10, 122, 10, 134, 3,
				143, 6, 160, 7, 168, 7 };
